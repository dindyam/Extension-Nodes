...
* If you can not do the above just have a pc with good internet connection to run these nodes

# 

### Block Network (Formaly Known As Blockless)
* Raised $8M M31 Capital, $BLS is announced
* Signup [here](https://bless.network/dashboard?ref=V9UDVD)
* Install [extension}
* Navigate to connect twitter and dicord 
...
* Invite Code: `x945qknd`
* connect twitter,discord and telegram
...
* Create account [here](https://app.gradient.network/signup?code=LVVUQW)
...
### Nodepay
* Backed by Animoca
* Create account [here](https://app.nodepay.ai/register?ref=bbjZzCI4w5YcV56)
...
* Create account [here](https://app.blockmesh.xyz/register?invite_code=2734970c-b5ba-41f5-8938-5a534c12d17a)
...
* Create account and Install Extension [here](https://node.securitylabs.xyz/?from=extension&type=signin&referralCode=cm57qp13vu13eny1b0u6jmyzg)
* It needs a code to join: `cm57qp13vu13eny1b0u6jmyzg`
...
* You can get more invite codes in [Discord](https://discord.gg/openlayer)
